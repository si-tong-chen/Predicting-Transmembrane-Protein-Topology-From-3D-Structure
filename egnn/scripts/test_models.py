...
sys.path.append("/Users/chensitong/DL/egnn")
sys.path.append("/Users/chensitong/DL/egnn/models")
sys.path.append("/Users/chensitong/DL/egnn/scripts")
import pickle
import os
...
def test():
    ...
    path = "/Users/chensitong/DL/egnn"
    batch_size = 1
    setup = "setup1"  # choose crossvalidation (total 5)
    modelpath = os.path.join(root_dir, "models", "final_model", "egnn_model_size1_epoch100.pth")
